...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '大胖狗', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个头发茂密💇🏻移动端开发者📱，新手奶爸🍼', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sunnb.site', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客,移动开发,生活感悟,互联网', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yonglongsun@gmail.com', // 邮箱地址 例如mail@tangly1024.com
